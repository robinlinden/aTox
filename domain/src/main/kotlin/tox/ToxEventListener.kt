...
class ToxEventListener @Inject constructor() : ToxCoreEventListener<Unit> {
    ...
    override fun friendReadReceipt(friendNumber: ToxFriendNumber, messageId: Int, state: Unit) =
        friendReadReceiptHandler(keyFor(friendNumber), messageId)
    ...
    override fun friendRequest(publicKey: ToxPublicKey, timeDelta: Int, message: ToxFriendRequestMessage, state: Unit) =
        friendRequestHandler(publicKey.value.bytesToHex(), timeDelta, String(message.value))
    ...
    override fun friendMessage(
        ...
        state: Unit,
    ) = friendMessageHandler(keyFor(friendNumber), messageType, timeDelta, String(message.value))
